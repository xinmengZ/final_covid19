...
#  config.vm.provision "shell", path: "bootstrap.sh"
  config.vm.provision "shell", path: "bootstrap.sh", env: {"http_proxy" => "http://10.0.2.2:11086", "https_proxy" => "http://10.0.2.2:11086"}
#  config.vm.provision "shell" do |s|
#    s.path "bootstrap.sh"
#    s.env "http_proxy=http://10.0.2.2:11086"
#    s.env "https_proxy=http://10.0.2.2:11086"
#  end
...
#    ansible.playbook = "playbook_all_master.yml"
